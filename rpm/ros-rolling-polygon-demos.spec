...
Name:           ros-rolling-polygon-demos
Version:        1.0.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS polygon_demos package

License:        BSD
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-angles
Requires:       ros-rolling-color-util
Requires:       ros-rolling-geometry-msgs
Requires:       ros-rolling-polygon-msgs
Requires:       ros-rolling-polygon-rviz-plugins
Requires:       ros-rolling-polygon-utils
...
BuildRequires:  ros-rolling-color-util
BuildRequires:  ros-rolling-geometry-msgs
BuildRequires:  ros-rolling-polygon-msgs
BuildRequires:  ros-rolling-polygon-rviz-plugins
BuildRequires:  ros-rolling-polygon-utils
...
%changelog
* Tue Jun 20 2023 David V. Lu!! <davidvlu@gmail.com> - 1.0.2-1
